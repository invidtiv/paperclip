...
export const agents = pgTable(
  "agents",
  {
    ...
    adapterType: text("adapter_type").notNull().default("autohand_local"),
    adapterConfig: jsonb("adapter_config").$type<Record<string, unknown>>().notNull().default({ model: "deepseek/deepseek-v4-flash:free" }),
