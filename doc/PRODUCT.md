...
1. **Local CLI/session adapters** — Paperclip starts or resumes local coding-tool sessions such as Claude Code, Codex, Gemini, Kimi, OpenCode, Pi, and Cursor, then tracks the run.
